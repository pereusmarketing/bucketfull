...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 17 19:59:49 2020
...
import pandas as pd
columnNames = ['first_name','last_name','email','company','phone_number','website','company_linkedin','address 1', 'city','state','zip','industry']
campaign = 'ML | Insurance You Keep (IYK) | Proj 1 Camp 8b - Final Camp'


df = pd.read_csv("/Users/jeremiahmcleod/Desktop/PereusMarketing/charge.csv")
df_orig = df
df.reset_index()
df.columns = columnNames
df = df[df['phone_number'].notna()]
df = df.drop_duplicates(['email','phone_number','last_name','first_name'],keep='last')
#del df['approval']
import re
...
df.to_csv("/Users/jeremiahmcleod/Desktop/PereusMarketing/compliancescan1.csv")
...
df43 = pd.read_csv(r"/Users/jeremiahmcleod/Desktop/PereusMarketing/detailed_.csv")
df43 = df43.iloc[1:]
